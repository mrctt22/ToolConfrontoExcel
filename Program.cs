...
namespace ToolConfrontoExcel
{
    ...
    class Controlli
    {
        ...
        public static (bool flag,  int result) Count_Numero_Record(DataTable dataTable1)
        {
            ...
            int rownum = dataTable1.Rows.Count;
            return (true,rownum);
        }
        public static int Cfr_Numero_Record(DataTable dataTable1, DataTable dataTable2)
        {
            if (dataTable1 is null)
            {
                return 2;
        ...
        public static DataTable Cfr_Record(DataTable dataTable1, DataTable dataTable2)
        {
            var differences1 = dataTable1.AsEnumerable().Except(dataTable2.AsEnumerable(), DataRowComparer.Default);
            var differences2 = dataTable2.AsEnumerable().Except(dataTable1.AsEnumerable(), DataRowComparer.Default);

            DataTable differenze1 = differences1.Any() ? differences1.CopyToDataTable() : new DataTable();
            DataTable differenze2 = differences2.Any() ? differences2.CopyToDataTable() : new DataTable();
            
            differenze1.Merge(differenze2);

            DataTable diff_tot = differenze1;
    ...
    class Utility
    {
        ...
        public static void Scrivi_Log(ListBox log_list, string log_string)
        {
            log_list.Items.Add(log_string);
        }
    }
}
